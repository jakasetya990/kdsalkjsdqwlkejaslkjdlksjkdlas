  ...
  axios.get(url_config)
    .then((r) => {
      ...
      if (webconfig.banner_img != "") {
        ...
        $('#ads_overlay').html('<button onclick="myClosebtn()"><span class="icon-cancel-circled">X</span></button> <div class="ads_code"><a href="' + webconfig.banner_link + '" target="_blank" rel="' + webconfig.banner_rel + '"><img src="' + webconfig.banner_img + '" /></a></div>')
      } else {
